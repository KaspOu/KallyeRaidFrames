...
local defaultOptions = {
	...
	AlphaInRange = 100,
	AlphaNotInRange = ns.DEFAULT_ALPHA_OUTOFRANGE, -- 50
...
--@do-not-package@
	...
	defaultOptions.Bar_Texture = "Interface\\AddOns\\KallyeRaidFrames\\Files\\button"
	defaultOptions.ShowMsgError = true
	defaultOptions.HealthAlpha = 90
	defaultOptions.FriendsNameplates_Bar_Texture = "Interface\\AddOns\\KallyeRaidFrames\\Files\\gradient_right"
